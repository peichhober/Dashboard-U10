  ...
  return (
    <div className="space-y-8">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <StatCard title="Top Performer" value={topPerformers[0].firstName} subtitle={`Avg: ${topPerformers[0].average}%`} icon={<Award className="w-6 h-6 text-amber-600" />} color="bg-amber-50" />
